...
function InstructorViewStaff() {
    ...
    useEffect(()=>{
    axios.get('https://localhost:5000/api/instructor/view-staff-dep',{headers:{'auth-token':token}}).then((res)=>{
...
export default InstructorViewStaff
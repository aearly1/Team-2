    ...
    return (
        ...
        <Navig>
            ...
            <Nav className="ml-auto">
                {props.isLoggedIn?(<Nav.Item><Nav.Link href="/" style = {{textDecoration:"underline", whiteSpace:"nowrap"}}><i class="fas fa-user-circle pr-1" ></i>{props.name}</Nav.Link></Nav.Item> ):(<Nav.Item className = "border border-1 border-warning mr-2" style={{borderRadius: 8}}><Nav.Link href="/login">Login</Nav.Link></Nav.Item>) }
